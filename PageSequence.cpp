...
{	
	...
	PageInfo page_info_templ(
		...
		image_desc.metadata, image_desc.multiPageFile,
		image_desc.numLogicalPages, image_desc.leftHalfRemoved,
		image_desc.rightHalfRemoved
	);
...
:	id(image_info.id()),
	...
	multiPageFile(image_info.isMultiPageFile())
{
}
